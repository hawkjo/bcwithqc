...
# Set the variables
CDNA_INPUT="../cDNA_fastqs_paired_end"
CDNA_CONFIG="../cDNA_paired_end_config.json"
STAR_INDEX="../SDR001_REF_index"

PREPROCESS_OUTPUT_DIR="./test_run/cDNA_paired_end/preprocess_output"
STAR_OUTPUT_DIR="./test_run/cDNA_paired_end/STAR_output/" #Trailing slash is required
COUNT_OUTPUT_DIR="./test_run/cDNA_paired_end/count_output"
...
--readFilesIn "$PREPROCESS_OUTPUT_DIR/sans_bc_cDNA_1_sequence.fq" "$PREPROCESS_OUTPUT_DIR/sans_bc_cDNA_2_sequence.fq" \
