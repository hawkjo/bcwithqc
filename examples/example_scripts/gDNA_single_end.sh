...
# Set the variables
CDNA_INPUT="../gDNA_fastqs_single_end"
CDNA_CONFIG="../gDNA_single_end_config.json"
STAR_INDEX="../SDR001_REF_index"

PREPROCESS_OUTPUT_DIR="./test_run/gDNA_single_end/preprocess_output"
STAR_OUTPUT_DIR="./test_run/gDNA_single_end/STAR_output/" #Trailing slash is required
COUNT_OUTPUT_DIR="./test_run/gDNA_single_end/count_output"
...
--readFilesIn "$PREPROCESS_OUTPUT_DIR/sans_bc_gDNA_1_sequence.fq" \
